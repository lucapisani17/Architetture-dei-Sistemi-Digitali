...
HD_PWD='C:/asdi/Elaborato_Finale/5.3_Cronometro_Intertempi/5.3_Cronometro_Intertempi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cronometro_onBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cronometro_onBoard.tcl -notrace
