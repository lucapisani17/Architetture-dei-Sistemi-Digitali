...
HD_PWD='C:/asdi/Elaborato_Finale/6_SistemaPO_PC/6_SistemaPO_PC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_onBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sistema_onBoard.tcl
