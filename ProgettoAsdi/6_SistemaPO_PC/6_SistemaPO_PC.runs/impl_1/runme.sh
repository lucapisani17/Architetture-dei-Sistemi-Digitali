...
HD_PWD='C:/asdi/Elaborato_Finale/6_SistemaPO_PC/6_SistemaPO_PC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sistema_onBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sistema_onBoard.tcl -notrace
