...
HD_PWD='C:/asdi/Elaborato_Finale/5.2_CronometroOnBoard_New/5.2_CronometroOnBoard_New.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cronometro_onBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cronometro_onBoard.tcl
