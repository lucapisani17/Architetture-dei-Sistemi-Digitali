...
HD_PWD='C:/asdi/Elaborato_Finale/1_Multiplexer/1_Multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rete_onBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rete_onBoard.tcl
