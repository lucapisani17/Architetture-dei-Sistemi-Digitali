...
HD_PWD='C:/asdi/Elaborato_Finale/1_Multiplexer/1_Multiplexer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rete_onBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rete_onBoard.tcl -notrace
