...
HD_PWD='C:/asdi/Elaborato_Finale/7_Booth_Balass/7_Booth_Balass.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log molt_booth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source molt_booth.tcl -notrace
