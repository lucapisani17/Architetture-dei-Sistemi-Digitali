...
HD_PWD='C:/asdi/Elaborato_Finale/7_Booth_Balass/7_Booth_Balass.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log molt_booth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source molt_booth.tcl
